    ...
    methods
        ...
        function response = getSearch(obj, queryText, options)
            ...
            query = { ...
                ...
                "enableFuzzyQuery", char(yfinance.internal.logicalToText(options.EnableFuzzyQuery)), ...
                "newsCount", char(string(options.NewsCount)), ...
                "quotesQueryId", "tss_match_phrase_query", ...
                "newsQueryId", "news_cie_vespa", ...
                "listsCount", char(string(options.ListsCount)), ...
                "enableCb", char(yfinance.internal.logicalToText(options.IncludeCb)), ...
                "enableNavLinks", char(yfinance.internal.logicalToText(options.IncludeNavLinks)), ...
                "enableResearchReports", char(yfinance.internal.logicalToText(options.IncludeResearch)), ...
                "enableCulturalAssets", char(yfinance.internal.logicalToText(options.IncludeCulturalAssets)), ...
                "recommendedCount", char(string(options.RecommendedCount))};
